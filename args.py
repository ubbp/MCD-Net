...
def get_parser():
    parser = argparse.ArgumentParser(description='MCDNet training and testing')
    ...
    parser.add_argument('--fusion_drop', default=0.0, type=float, help='dropout rate')
    ...
    parser.add_argument('--model_id', default='MCDNet', help='name to identify the model')
    ...
    parser.add_argument('--refer_data_root', default='RefSegRS/', help='REFER dataset root directory')
    ...
    parser.add_argument('--num_adf', default=1, type=int, help='number of adf layers')  # 1 for RefSegRS, 3 for RRSIS-D
    return parser
